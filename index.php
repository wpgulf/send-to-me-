...
<html class="no-js" lang="">
	<head>
        ...
        <title>Send to Me - Simple contact form in PHP & jQuery</title>
	...
	<body>
		...
		<h1 class="page-title">Send to Me</h1>
		...
		<div class="foot">Coded with <i class="fa fa-heart"></i> by <a href="http://www.wpgulf.com">Mustafa Hany</a> 
			<p><a href="https://github.com/wpgulf?tab=repositories" class="btn btn-github" target="_blank" rel="external"><i class="fa fa-github"></i> DOWNLOAD SOURCE</a></p>
		</div>
